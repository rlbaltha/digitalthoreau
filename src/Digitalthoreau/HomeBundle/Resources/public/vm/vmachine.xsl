...
<xsl:stylesheet version="1.1" exclude-result-prefixes="tei"
   ...
   <xsl:variable name="vmLogo">/digitalthoreau/web/bundles/digitalthoreauhome/vm/poweredby.gif</xsl:variable>
   
   <xsl:variable name="cssInclude">/digitalthoreau/web/bundles/digitalthoreauhome/vm/vmachine.css</xsl:variable>
   ...
   and modify the filename below (for example, "vmachine.js" becomes
   "vmachine.js") -->
   <xsl:variable name="jsInclude">/digitalthoreau/web/bundles/digitalthoreauhome/vm/vmachine.js</xsl:variable>
  ...
  "true" to "false" below -->
   ...
   <xsl:template name="htmlHead">
      <head>
         ...
         <xsl:comment><![CDATA[[if IE 6]>
            <link rel="stylesheet" type="text/css" href="vmachine_ie6.css">
         <![endif]]]></xsl:comment>
   ...
   <xsl:template name="headline">
      ...
      <img id="topEdge" src="/digitalthoreau/web/bundles/digitalthoreauhome/vm/topedge.gif" alt="" />
   </xsl:template>
   ...
   <xsl:template name="manuscriptPanel">
      ...
      <div class="panel mssPanel">
         <div class="panelBanner">
            <img class="closePanel" onclick="closePanel(this.parentNode.parentNode);" src="/digitalthoreau/web/bundles/digitalthoreauhome/vm/closePanel.gif" alt="X" />
   ...
   <xsl:template match="/tei:TEI/tei:teiHeader/tei:fileDesc">
      <div class="panel" id="bibPanel">
         ...
         <div class="panelBanner">
            <img class="closePanel" onclick="toggleBiblio();" alt="X" src="/digitalthoreau/web/bundles/digitalthoreauhome/vm/closePanel.gif" />
   ...
   <xsl:template name="notesPanel">
      <div class="panel" id="notesPanel">
         ...
         <div class="panelBanner">
            <img class="closePanel" onclick="hideNotesPanel();" alt="X" src="/digitalthoreau/web/bundles/digitalthoreauhome/vm/closePanel.gif" />
            Textual Notes
         </div>
   ...
   <xsl:template name="imageLink">
      ...
      <xsl:if test="$imageURL != ''">
         <img src="/digitalthoreau/web/bundles/digitalthoreauhome/vm/image.gif">
            <xsl:attribute name="class">
   ...
   <xsl:template name="imageViewer">
      <div class="viewerRoot" id="panel_imageViewer">
         <div title="Click to drag panel." class="viewerHandle" id="handle_imageViewer">
            ...
            <img class="viewerHandleRt" onclick="return hidePanel('imageViewer');" alt="X" src="/digitalthoreau/web/bundles/digitalthoreauhome/vm/closePanel.gif" />
         </div>
